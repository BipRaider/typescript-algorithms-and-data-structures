 ...
 * @returns {Callbacks}
 */
function initCallbacks(callbacks: Record<string, any> = {}) {
 ...
 */
export default function breadthFirstSearch(graph: Graph, startVertex: GraphVertex, originalCallbacks: Function) {
