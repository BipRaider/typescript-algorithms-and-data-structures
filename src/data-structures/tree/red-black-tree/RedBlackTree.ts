...
export default class RedBlackTree extends BinarySearchTree {
  ...
  root(insertedNode: any, root: any) {
   ...
   */
  balance(node: { parent: { parent: any; left: any; right: any }; uncle: any }) {
   ...
   * @return {BinarySearchTreeNode}
   */
  leftLeftRotation(grandParentNode: { parent: any; left: any; setLeft: (arg0: any) => void }) {
   ...
   * @return {BinarySearchTreeNode}
   */
  leftRightRotation(grandParentNode: { left: any; setLeft: (arg0: any) => void }) {
   ...
   * @return {BinarySearchTreeNode}
   */
  rightRightRotation(grandParentNode: { parent: any; right: any; setRight: (arg0: any) => void }) {
    // Memorize the parent of grand-parent node.
    const grandGrandParent = grandParentNode.parent;
   ...
   * @return {BinarySearchTreeNode}
   */
  rightLeftRotation(grandParentNode: { right: any; setRight: (arg0: any) => void }) {
   ...
   * @return {BinarySearchTreeNode}
   */
  makeNodeRed(node: { meta: { set: (arg0: string, arg1: string) => void } }) {
   ...
   * @return {BinarySearchTreeNode}
   */
  makeNodeBlack(node: { meta: { set: (arg0: string, arg1: string) => void } }) {
   ...
   * @return {boolean}
   */
  isNodeRed(node: { meta: { get: (arg0: string) => string } }) {
   ...
   * @return {boolean}
   */
  isNodeBlack(node: { meta: { get: (arg0: string) => string } }) {
   ...
   */
  swapNodeColors(
    firstNode: { meta: { get: (arg0: string) => any; set: (arg0: string, arg1: any) => void } },
    secondNode: { meta: { get: (arg0: string) => any; set: (arg0: string, arg1: any) => void } },
  ) {
